/*
 * This example shows how to use WebSerialLite variant to send data to the browser when timing, speed and latency are important.
 * WebSerialLite focuses on reducing latency and increasing speed by enqueueing messages and sending them in a single packet.
 *
 ...
 *
 * You might want to look at the Logging variant to see how to better use WebSerialLite for streaming logging.
 *
